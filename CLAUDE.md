...
processors/   # Document type-specific processors (PDF, DOCX, XLSX, CSV, HTML, images)
...
- `processors/`: Format-specific processors (PDF, DOCX, XLSX, CSV, HTML, Image)
...
- Supports PDF, DOCX, XLSX/XLS, CSV/TSV, HTML, and image formats
